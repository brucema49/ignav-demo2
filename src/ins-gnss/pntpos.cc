...
static int ProcessWsPH(WindowedResiduals *windowed_residuals,const double *P,const double *H,const int n,const int m){
...
static int ChiSquareTestWS(WindowedResiduals *windowed_residuals,const double* P,const double* H,const int nx,const int m){
...
/*存储H和P,不在存储A*/
static int ProcessWiPH(WindowedResiduals *windowed_residuals,const double *P,const double *H,const int nx){
